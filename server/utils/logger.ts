...
export function sanitizeUrlForLogging(url: string): string {
  try {
    ...
    const sensitiveParams = [
      ...
      'password', 'pass', 'pwd', 'auth', 'authorization',
      'session', 'sid', 'jwt', 'bearer', 'oauth'
    ]
 ...
 */
export function truncate(str: string | undefined, maxLength: number = 200): string | undefined {
...
export function logSuccess(data: {
  ...
  log({
    ...
    finalUrl: data.finalUrl !== data.url ? sanitizeUrlForLogging(data.finalUrl) : undefined,
