...
export const useMetaParser = () => {
  const parseMetaTags = (html: string): MetaTags => {
    ...
    const language = getMeta('meta[name="language"]') || getMeta('meta[http-equiv="content-language"]')
    ...
    const pinterest = {
      description: getMeta('meta[name="pinterest-rich-pin-description"]') || getMeta('meta[name="pinterest:description"]'),
    }
    ...
    const apple = {
      ...
      mobileWebAppStatusBarStyle: getMeta('meta[name="apple-mobile-web-app-status-bar-style"]'),
